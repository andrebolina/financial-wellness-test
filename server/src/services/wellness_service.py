from utils.constants.wellness_constants import LOW_SCORE, MEDIUM_SCORE, HEALTHY_SCORE
...
def calculate_wellness_score(annual_income, monthly_costs):
  ...
  annual_compensation = int(annual_income) - int(annual_income) * TAX_PERCENTAGE
